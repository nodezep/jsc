...
const JSCZones = () => {
  ...
  return (
    <>
      <Helmet>
        <title>JSC Zones - Jerusalem Spiritual Centre</title>
        <meta name="description" content="Join a JSC Zone at Jerusalem Spiritual Centre and build meaningful relationships while growing in faith. Find groups for all ages and life stages." />
      </Helmet>
